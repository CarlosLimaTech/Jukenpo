...
import br.edu.ifsp.jukenpo.view.Constants
...
class MainActivity : AppCompatActivity() {
    ...
    private fun startGame() {
        ...
        val playAgainstBot = binding.spinnerButtles.selectedItemPosition == 3
        ...
        mIntent.putExtra(Constants.KEY_PLAYER_2, if (playAgainstBot) "Bot" else binding.edittextPlayer2.text.toString())
